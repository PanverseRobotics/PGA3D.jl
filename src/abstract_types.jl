...
getindex(el::AbstractPGA3Element, i::Integer) = internal_vec(el)[i]
size(el::AbstractPGA3Element) = size(internal_vec(el))
length(el::AbstractPGA3Element) = length(internal_vec(el))
